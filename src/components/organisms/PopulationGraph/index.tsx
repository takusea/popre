...
const PopulationGraph = ({
  ...
  const graphData: graphData[] = populations.reduce(
    (acc: graphData[], current) => {
  ...
  if (graphData.length > 0) {
    return (
      <ResponsiveContainer width="100%" height={480}>
        <LineChart data={graphData} margin={{ top: 40, right: 64, left: 16 }}>
    ...
    return <div className={styles.empty}>都道府県を選択してください。</div>;
  }
};
